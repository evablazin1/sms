...
public interface SubjectRepository extends JpaRepository<SubjectDomain,Long>,PagingAndSortingRepository<SubjectDomain, Long>{
	...
	@Query("select sd from SubjectDomain sd where sd.schoolID=:schoolID AND sd.classID=:classID")
	public List<SubjectDomain> findBySchoolIDAndClassID(@Param("schoolID")Long schoolID,@Param("classID")Long classID);
}
