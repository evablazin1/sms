	...
	<jsp:body>
		  <div class="span4"></div>
				...
				<h3>List of Subjects</h3>
					 ...
					 <div id="emptyDiv" style="display:none">There are no subjects registered for this class yet.Please register a subject below</div>
				...
				<div class="btn-group pull-right">
						<a href="<c:url value='/class/register-subject?schoolID=${schoolID}&classID=${classID}'/>">
				 ...
				 if (!$.isEmptyObject(dataFromServer)){
					var listOfSubjects              			    = "";
					  $.each(dataFromServer,function(index,value){
						  var studentUrl						    = "<c:url value='/class/student-subject?schoolID="+schoolID+"&classID="+classID+"&subjectID="+value.subjectID+"'/>";
